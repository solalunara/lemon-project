...
public:
	...
	float TraceFirePortal( bool bPortal2, const Vector &vTraceStart, const Vector &vDirection, trace_t &tr, Vector &vRelativeVel, QAngle &qRelativeVel, Vector &vFinalPosition, QAngle &qFinalAngles, int iPlacedBy, bool bTest = false );
