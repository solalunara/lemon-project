...
void PhysCannonPickupObject( CBasePlayer *pPlayer, CBaseEntity *pEntity )
{
	dynamic_cast<CWeaponPhysCannon *>( pPlayer->GetActiveWeapon() )->AttachObject( pEntity, pEntity->GetAbsOrigin() );
}
//-----------------------------------------------------------------------------
// Purpose: 
// Input  : *pObject - 
