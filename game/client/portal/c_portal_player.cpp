...
#define REORIENTATION_RATE 1200.0f
#define REORIENTATION_ACCELERATION_RATE 4000.0f
...
bool C_Portal_Player::DetectAndHandlePortalTeleportation( void )
{
	if( m_bPortalledMessagePending )
	{
		...
		//if( pOldPortal )
		{
			Vector ptNewPosition = GetAbsOrigin();
			...
			m_PlayerAnimState->Teleport ( &ptNewPosition, &GetAbsAngles(), this );
...
void C_Portal_Player::CalcPortalView( Vector &eyeOrigin, QAngle &eyeAngles )
{
	...
	ptPortalCenter = pPortal->GetAbsOrigin();
